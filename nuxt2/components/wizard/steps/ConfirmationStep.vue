...
<template>
  <div class="flex flex-col h-full">
      ...
      <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="rounded-xl border border-border bg-card p-5 text-center">
            ...
            <div class="text-sm text-muted-foreground">Tiempo estimado</div>
          </div>
        </div>
        ...
        <div class="rounded-xl border border-border bg-card overflow-hidden">
          <div
            class="p-4 border-b border-border bg-muted/30 flex items-center gap-2"
          >
          ...
          <div class="max-h-64 overflow-auto">
            ...
            >
              <span
                class="text-muted-foreground font-mono text-xs w-6 flex-shrink-0"
              >
                {{ index + 1 }}.
              </span>
        ...
        <!-- Analysis Info -->
        <div
          class="rounded-xl bg-gradient-to-r from-primary/5 to-primary/10 border border-primary/20 p-5"
        >
    ...
    >
      ...
      <Button class="gap-2" @click="onConfirm">
